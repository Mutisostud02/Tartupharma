        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p>
              ...
              Food, Vitamin, Herbal and Supplement industries throughout Estonia
              and internationally for more than 15 years. Our customers range
              from private label and generic manufacturers through to global
              brands.
            </p>
            ...
            <p>
              Tartupharma Medical Equipments was founded in 2008 and in our
              location in Tartu, Estonia we maintain a large showroom and fully
              equipped workshop. Our facilities are easily reached by car or
              public transport from anywhere in the Baltic region.
            </p>
            ...
            <div className="company-highlights">
              ...
              <ul>
                <li>
                  <strong>15+ Years Experience</strong> in pharmaceutical
                  equipment
                </li>
                <li>
                  <strong>Quality Assurance</strong> - All equipment thoroughly
                  tested
                </li>
                <li>
                  <strong>Expert Support</strong> - Technical guidance and
                  installation assistance
                </li>
                <li>
                  <strong>Competitive Pricing</strong> - Cost-effective
                  alternatives to new equipment
                </li>
                <li>
                  <strong>Fast Delivery</strong> - Equipment ready for immediate
                  installation
                </li>
                <li>
                  <strong>International Reach</strong> - Serving customers
            ...
            <div className="contact-cta">
              ...
              <div className="cta-buttons">
                <a
                  href="mailto:info@tartupharmamedics.com"
