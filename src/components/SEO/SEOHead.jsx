...
const SEOHead = ({ 
  ...
  const defaultTitle = 'Tartupharma Medical Equipments - Pharmaceutical Machinery & Equipment Kenya';
  const defaultDescription = 'Leading supplier of pharmaceutical equipment in Kenya. Granulators, tablet presses, capsule filling machines, coating equipment, and more. Quality medical machinery for pharmaceutical manufacturing.';
  const defaultKeywords = 'pharmaceutical equipment Kenya, medical machinery, tablet presses, granulators, capsule filling machines, coating equipment, pharmaceutical manufacturing, medical equipment supplier';
  ...
  }, [finalTitle, finalDescription, finalKeywords, finalCanonical, finalOgImage, ogType, noindex]);
